#!/usr/bin/env python3
# VERSIONE CON PAUSA FINALE: la finestra resta aperta finche' non premi Invio.
import traceback
def _main():
    # =============================================================================
...
try:
    ...
    print("\n*** ERRORE - copia tutto questo testo e mandalo a Claude: ***\n")
    traceback.print_exc()

input("\n\n>>> FATTO. Premi INVIO per chiudere questa finestra <<<")
